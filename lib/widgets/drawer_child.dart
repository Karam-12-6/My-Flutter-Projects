    ...
    return LayoutBuilder(builder: (context, constraints) {
      return GestureDetector(
        ...
        child: Column(
          ...
          children: [
            CalculationHistoryHeader(
                controller: controller,
                singleCalculationController: singleCalculationController),
      ...
      return Row(
        children: [
            ...
            child: Ink(
              ...
              child: InkWell(
                onLongPress: () {
                  ...
                  singleCalculationController.setCalculationCheckBox(index);
                ...
                onTap: () {
                  ...
                  context
                      ...
                      .text = drawer_controller.calculations[index].expression!;
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            drawer_controller.calculations[index].timestamp
                                .toString()
          ...
          Visibility(
            ...
            child: Checkbox(
              value: drawer_controller.toDelete
                  .contains(drawer_controller.calculations[index].id),
              onChanged: (value) {
                singleCalculationController.setCalculationCheckBox(index);
                value = !(value ?? true);
              },
...
class CalculationHistoryHeader extends StatelessWidget {
  const CalculationHistoryHeader({
    super.key,
    required this.controller,
    required this.singleCalculationController,
  });

  final drawer_controller.DrawerController controller;
  final drawer_controller.SingleCalculationController
        ...
        children: [
          ...
          Visibility(
            ...
            child: Row(
              children: [
                TextButton(
                  onPressed: () => singleCalculationController.selectAll(),
                  child: const Text(
                    'Select All',
                    style: TextStyle(
                      color: Colors.black,
